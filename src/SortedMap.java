...
public interface SortedMap extends Map{
   ...
   */
  Entry ceilingEntry(Integer key) throws IllegalArgumentException;
   ...
   * @throws IllegalArgumentException if the key is not compatible with the map
   */
  Entry floorEntry(Integer key) throws IllegalArgumentException;
   ...
   * @throws IllegalArgumentException if the key is not compatible with the map
   */
  Entry lowerEntry(Integer key) throws IllegalArgumentException;
   ...
   * @throws IllegalArgumentException if the key is not compatible with the map
   */
  Entry higherEntry(Integer key) throws IllegalArgumentException;
   ...
   */
  Iterable<Entry> subMap(Integer fromKey, Integer toKey) throws IllegalArgumentException;
}
