...
public class SinglyLinkedList implements Cloneable {
  ...
  private static class Node {
    ...
    private Position element;            // reference to the element stored at this node
     ...
     */
    public Position getElement() { return element; }
   ...
   */
  public Position first() {             // returns (but does not remove) the first element
   ...
   */
  public Position last() {              // returns (but does not remove) the last element
    if (isEmpty()) return null;
   ...
   */
  public void addFirst(Position e) {                // adds element e to the front of the list
   ...
   * @param e  the new element to add
   */
  public void addLast(Position e) {                 // adds element e to the end of the list
   ...
   */
  public Position removeFirst() {                   // removes and returns the first element
    if (isEmpty()) return null;              // nothing to remove
    Position answer = head.getElement();
