...
public abstract class AbstractSortedMap
  extends AbstractMap implements SortedMap {
  ...
  protected int compare(Integer a, Entry b) {
    return comp.compare(a, b.getKey());
  }

  /** Method for comparing a key and an entry's key */
  protected int compare(Entry a, Integer b) {
  ...
  protected boolean checkKey(Integer key) throws IllegalArgumentException {
    try {
